...
@op(torch.ops.aten.conv1d)
def _aten_conv1d(input, weight, bias=None, stride=1, padding=0, dilation=1, groups=1):
    # 确保stride、padding和dilation是元组格式
    ...
    if isinstance(dilation, int):
        dilation = (dilation,)
    # MindSpore的Conv1D接口参数与PyTorch基本一致
    return ops.conv1d(input, weight, bias, stride, padding, dilation, groups)